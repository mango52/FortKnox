...
public abstract class Database {
	...
	protected Statements getStatement(String query) throws SQLException {
		 ...
		 * SQLException("Queries must be at least 10 characters long.");
		 */
		...
		if ((query.length() > 5)
			...
			return Statements.DELETE;
				...
				&& query.substring(0, 2).equalsIgnoreCase("DO")) {
			return Statements.DO;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("REPLACE")) {
			return Statements.REPLACE;
		} else if ((query.length() > 3)
				&& query.substring(0, 4).equalsIgnoreCase("LOAD")) {
			return Statements.LOAD;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("HANDLER")) {
			return Statements.HANDLER;
		} else if ((query.length() > 3)
				&& query.substring(0, 4).equalsIgnoreCase("CALL")) {
			return Statements.CALL;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("CREATE")) {
			return Statements.CREATE;
		} else if ((query.length() > 4)
				&& query.substring(0, 5).equalsIgnoreCase("ALTER")) {
			return Statements.ALTER;
		} else if ((query.length() > 3)
				&& query.substring(0, 4).equalsIgnoreCase("DROP")) {
			return Statements.DROP;
		} else if ((query.length() > 7)
				&& query.substring(0, 8).equalsIgnoreCase("TRUNCATE")) {
			return Statements.TRUNCATE;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("RENAME")) {
			return Statements.RENAME;
		} else if ((query.length() > 4)
				&& query.substring(0, 5).equalsIgnoreCase("START")) {
			return Statements.START;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("COMMIT")) {
			return Statements.COMMIT;
		} else if ((query.length() > 7)
				&& query.substring(0, 8).equalsIgnoreCase("ROLLBACK")) {
			return Statements.ROLLBACK;
		} else if ((query.length() > 8)
				&& query.substring(0, 9).equalsIgnoreCase("SAVEPOINT")) {
			return Statements.SAVEPOINT;
		} else if ((query.length() > 3)
				&& query.substring(0, 4).equalsIgnoreCase("LOCK")) {
			return Statements.LOCK;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("UNLOCK")) {
			return Statements.UNLOCK;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("PREPARE")) {
			return Statements.PREPARE;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("EXECUTE")) {
			return Statements.EXECUTE;
		} else if ((query.length() > 9)
				&& query.substring(0, 10).equalsIgnoreCase("DEALLOCATE")) {
			return Statements.DEALLOCATE;
		} else if ((query.length() > 2)
				&& query.substring(0, 3).equalsIgnoreCase("SET")) {
			return Statements.SET;
		} else if ((query.length() > 3)
				&& query.substring(0, 4).equalsIgnoreCase("SHOW")) {
			return Statements.SHOW;
		} else if ((query.length() > 7)
				&& query.substring(0, 8).equalsIgnoreCase("DESCRIBE")) {
			return Statements.DESCRIBE;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("EXPLAIN")) {
			return Statements.EXPLAIN;
		} else if ((query.length() > 3)
				&& query.substring(0, 4).equalsIgnoreCase("HELP")) {
			return Statements.HELP;
		} else if ((query.length() > 2)
				&& query.substring(0, 3).equalsIgnoreCase("USE")) {
			return Statements.USE;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("ANALYSE")) {
			return Statements.ANALYZE;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("ATTACH")) {
			return Statements.ATTACH;
		} else if ((query.length() > 4)
				&& query.substring(0, 5).equalsIgnoreCase("BEGIN")) {
			return Statements.BEGIN;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("DETACH")) {
			return Statements.DETACH;
		} else if ((query.length() > 2)
				&& query.substring(0, 3).equalsIgnoreCase("END")) {
			return Statements.END;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("INDEXED")) {
			return Statements.INDEXED;
		} else if ((query.length() > 1)
				&& query.substring(0, 2).equalsIgnoreCase("ON")) {
			return Statements.ON;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("PRAGMA")) {
			return Statements.PRAGMA;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("REINDEX")) {
			return Statements.REINDEX;
		} else if ((query.length() > 6)
				&& query.substring(0, 7).equalsIgnoreCase("RELEASE")) {
			return Statements.RELEASE;
		} else if ((query.length() > 5)
				&& query.substring(0, 6).equalsIgnoreCase("VACUUM")) {
